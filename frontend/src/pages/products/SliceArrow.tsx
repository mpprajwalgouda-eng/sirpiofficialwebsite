  ...
  <>
    ...
    <section style={{ background: CREAM, padding: "6rem 3rem" }}>
      <div style={{ maxWidth: 640, margin: "0 auto", textAlign: "center" }}>
        ...
        <Link
          to="/contact"
          style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "14px 28px", background: N, color: FROST, borderRadius: 6, fontWeight: 600, fontSize: 14, textDecoration: "none" }}
        >
